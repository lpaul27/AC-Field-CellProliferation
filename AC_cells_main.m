...
for l = 1:outerSteps
    for p = 1:steps
        ...
        vels_med = 0.2;                         % initial velocity param center point
        ...
        %% Cell Parameters
        critRad = 2.4;                          % critical radius for mitosis
...
%         end
    ...
    displacementAvg(l,1) = median(displacementVal)
    if(isnan(displacementAvg))
        break
    end
end
